...
- Вёрстка семантическая +20
  ...
  - два input: <input type="email"> и <input type="tel"> +2
...
- Требования к css + 12
  - для построения сетки используются flex или grid +2
...
- Интерактивность, реализуемая через css +20
  ...
  - ссылки в футере ведут на github автора проекта и на страницу курса https://rs.school/js-stage0/ +5
